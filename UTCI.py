...
def utci_numpy(temperature_air, temperature_mrt, wind_speed, relative_humidity):
    ...
    utci_approx = temperature_air + 0.607562052 - 0.0227712343 * temperature_air + (
                8.06470249 * (10 ** (-4))) * np.power(temperature_air, 2) + (-1.54271372 * (10 ** (-4))) * np.power(
        temperature_air, 3) + (-3.24651735 * (10 ** (-6))) * np.power(temperature_air, 4) + (
                              7.32602852 * (10 ** (-8))) * np.power(temperature_air, 5) + (
                              1.35959073 * (10 ** (-9))) * np.power(temperature_air, 6) + (
                      -2.25836520) * wind_speed + 0.0880326035 * temperature_air * wind_speed + 0.00216844454 * np.power(
        temperature_air, 2) * wind_speed + (-1.53347087 * (10 ** (-5))) * np.power(temperature_air, 3) * wind_speed + (
                              -5.72983704 * (10 ** (-7))) * np.power(temperature_air, 4) * wind_speed + (
                              -2.55090145 * (10 ** (-9))) * np.power(temperature_air, 5) * wind_speed + (
                      -0.751269505) * np.power(wind_speed, 2) + (-0.00408350271) * temperature_air * np.power(
        wind_speed, 2) + (-5.21670675 * (10 ** (-5))) * np.power(temperature_air, 2) * np.power(wind_speed, 2) + (
                              1.94544667 * (10 ** (-6))) * np.power(temperature_air, 3) * np.power(wind_speed, 2) + (
                              1.14099531 * (10 ** (-8))) * np.power(temperature_air, 4) * np.power(wind_speed,
                                                                                                   2) + 0.158137256 * np.power(
        wind_speed, 3) + (-6.57263143 * (10 ** (-5))) * temperature_air * np.power(wind_speed, 3) + (2.22697524 * (
